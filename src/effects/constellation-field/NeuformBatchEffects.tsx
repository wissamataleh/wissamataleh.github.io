...
const EFFECTS = {
  constellationField: {
    ...
    patch(source, { size, length, density, strokeWidth, mode }) {
      ...
      if (mode === "light") {
        // Keep the constellation golden while staying readable on light paper.
        next = next
          .replace("ctx.strokeStyle = '#E6C879';", "ctx.strokeStyle = '#B8860B';")
          .replace("ctx.fillStyle = '#E6C879';", "ctx.fillStyle = '#B8860B';");
      } else {
        // Dark mode: cool blue constellation over the deep night field.
        next = next
          .replace("ctx.strokeStyle = '#E6C879';", "ctx.strokeStyle = '#50A0F0';")
          .replace("ctx.fillStyle = '#E6C879';", "ctx.fillStyle = '#50A0F0';");
      }
      return next;
    },
  },
